...
const Wallet = () => {
  ...
  {user && user.emailVerified ?   <div className='container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between'>
      ...
      </div>:<h2>pls veryfy toure emil</h2>}
