...
const Navbar = () => {
  ...
  const singout=()=>{
    logout().then(()=>{toast.warning("user logout")
    ...
    <header className='text-gray-600 body-font'>
      <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
        ...
        <nav className='md:ml-auto flex flex-wrap items-center text-base justify-center'>
          ...
          <button onClick={singout} className='inline-flex items-center bg-gray-300 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0'>
            Logout
            <svg
              fill='none'
              stroke='currentColor'
